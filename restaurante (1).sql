...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2018 a las 22:20:36
...
--
-- Volcado de datos para la tabla `detalle_presencial`
--

INSERT INTO `detalle_presencial` (`iddetalle_presencial`, `fecha_venta`, `cantidad`, `forma_pago_idforma_pago`, `mesas_idmesas`, `plato_idplato`) VALUES
(1, '2018-12-05', '32132', 3, 5, 1),
(2, '2018-12-05', '1231', 3, 5, 1),
(3, '2018-12-05', '2222', 3, 5, 1);
...
(1, 'srdfsdfsd', 'fdsfsdfdssd', '12-05-2018-2-58pmalmuerzos.jpg', '33333');
...
--
ALTER TABLE `detalle_presencial`
  MODIFY `iddetalle_presencial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `plato`
  MODIFY `idPlato` int(11) NOT NULL AUTO_INCREMENT COMMENT 'identificador unico', AUTO_INCREMENT=2;
